...
<div class="container" >
   ...
   <form method="POST" action="">
    ...
    <div id="success"></div>
    <div class="form-group">
     <button type="submit" class="btn btn-primary" id="send_button">Submit Code</button>
    </div>
   </form>
 </div>
</div>
...
function register_submit(){
  ...
  if (!otp || (otp == "")) {
    $('#op').html('<div class="alert alert-danger animated bounce" role="alert"><i class="fa fa-warning animated swing infinite"></i> Please enter the code sent to your email address</div>');
  } 
  else {
    ...
    $.ajax({  
        ...
        {  
            ...
            if (response.message !== 'success') {
              ...
              // clear the fields
              $('#op').html('<div class="alert alert-success animated bounce" role="alert"><i class="fa fa-tick"></i>  Redirecting to Dashboard </div>');
